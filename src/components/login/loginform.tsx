    ...
    <div className='flex min-h-screen items-center justify-center py-10 px-4 sm:px-6 lg:px-8 bg-slate-100'>
      <div className='w-full max-w-lg space-y-8 bg-white rounded-md shadow shadow-slate-300 py-10 px-10'>
        ...
        >
          <button
            type='button'
            className='inline-flex w-full justify-center text-center items-center py-2 px-4 text-sm font-medium text-gray-900 bg-transparent rounded-l-lg border border-gray-900 hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white'
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 48 48'
          ...
          <button
            type='button'
            className=' border-l-0 inline-flex w-full text-center justify-center items-center py-2 px-4 text-sm font-medium text-gray-900 bg-transparent rounded-r-md border border-gray-900 hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white'
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 48 48'
        ...
        {/* <button
          type='button'
          className='w-1/2 text-gray-500 border text-sm border-slate-200 bg-white hover:bg-slate-500  focus:ring-4  focus:ring-slate-300  rounded-lg px-5 py-2.5 mr-2 mb-2  focus:outline-none'
        >
